...
func fixtureInputs(t *testing.T, mutate func(*[]Event)) Inputs {
	...
	events := []Event{
		...
		{SchemaVersion: EventSchema, EventID: "00000000-0000-7000-8000-000000000005", Sequence: 5, ObservedAt: "2026-09-11T12:00:04Z", MonotonicNS: 5, Build: build, Operation: "sensor_finalized", Outcome: Outcome{Status: "success"}, Sensor: sensor, Resource: map[string]any{"kernel_reserve": 0, "decode": 0, "queue": 0, "persistence": 0, "counter_read_error": false}},
	}
	if mutate != nil {
		mutate(&events)
	}
